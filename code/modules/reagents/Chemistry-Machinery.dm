...
/obj/structure/chemical_dispenser/debug
	New()
		..()
		var/list/elements = list("thc", "ketamine", "pervitin", "cocaine", "hydrogen", "helium", "lithium", "nitrogen", "oxygen", "fluorine", "sodium", "magnesium", "aluminum", "silicon", "phosphorus", "chlorine", "potassium", "calcium", "arsenic", "iodine", "tungsten", "radium", "thorium", "bromine", "blood", "phosgene_gas", "zyklon_b", "chlorine_gas", "white_phosphorus_gas", "mustard_gas", "xylyl_bromide", "plasticide", "amatoxin", "carpotoxin", "plasma", "cyanide", "cholera", "potassium_chloride", "potassium_chlorophoride", "zombiepowder", "fertilizer", "eznutrient", "left4zed", "robustharvest", "pacid", "lexorin", "stoxin", "chloralhydrate", "peyote", "serotrotium", "cryptobiolin", "impedrezene", "mindbreaker", "psilocybin", "nicotine", "bleach", "solanine", "nitroglycerin", "gunpowder", "lube", "biodiesel", "diesel", "gasoline", "petroleum", "luminol", "glue", "cleaner", "adminordrazine", "adrenaline", "anti_toxin", "charcoal", "tricordrazine", "paracetamol", "tramadol", "oxycodone", "synaptizine", "alkysine", "imidazoline", "peridaxon", "hyperzine", "potassium_iodide", "penicillin", "prontosil", "opium", "methamphetamine", "paroxetine", "citalopram", "methylphenidate", "morphine", "pen_acid", "sal_acid", "carbon", "acetone","lemonjuice")
		for (var/i in elements)
